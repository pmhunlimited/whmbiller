...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['action']) && $_POST['action'] === 'add_server') {
        ...
        $stmt = $db->prepare("INSERT INTO servers (name, hostname, username, api_token) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("ssss", $name, $host, $user, $token);
        $stmt->execute();
    }
}
...
<div class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="bi bi-server text-primary"></i> Server Management</h2>
            ...
            <div class="card p-4 mb-4">
                ...
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="hostname" class="form-control" placeholder="server.example.com" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline-info">Sync Accounts</button>
                                    <button class="btn btn-sm btn-outline-primary">Edit</button>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                            <?php if($servers->num_rows == 0): ?>
                            <tr><td colspan="4" class="text-center text-muted">No servers configured.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
